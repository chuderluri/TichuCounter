...
description: >
  ...
  Use when writing or reviewing Kotlin/Jetpack Compose code in this project:
  composables, ViewModels, MVVM/MVI state, Navigation, Hilt, Room, DataStore,
  Ktor, coroutines/Flow, Material 3, testing. Also covers Gradle build setup.
---
